# Homework 3: Discretization, Numerical Convergence, and Simulation

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is the repository for Homework 3 for [BEE 4750](https://envsys.viveks.me/), taught at [Cornell University](https://cornell.edu) in Fall 2026 by [Vivek Srikrishnan](https://viveks.me).
...
- discretize a system model with forward Euler and reason about characteristic timescales for both linear and nonlinear systems;
- predict how forward Euler's error scales with step size, given the method's convergence order;
- extend a systems model to include an additional coupled stock, and derive its (vector) forward Euler update;
- run a numerical convergence study and distinguish between step-size convergence and simulation-horizon convergence;
- use simulation results to reason about the risk of using simplified models or short simulations to inform a management decision.
...
- `hw03.qmd`: Source file for Jupyter notebook generation. You shouldn't need to or want to touch this unless you use Quarto to write your solution; everything is in the `.ipynb` file.
